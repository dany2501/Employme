$(document).ready(function () {
  ...
  interes.on('click', () => {
    $.ajax({
      url: 'http://3.93.218.234/aspirantes',
      type: 'post',
      dataType: 'json',
  ...
  $.post("http://3.93.218.234/aspirante", function (data) {
...
e.preventDefault() ;
  ...
  $.ajax({
    url: 'http://3.93.218.234/aspirante',
    type: 'put',
    dataType: 'json',
  ...
  var bandera = false;
  $.ajax({
    url: 'http://3.93.218.234/aspirantes/know',
    type: 'get',
    dataType: 'json',
    success: function (json) {

$(document).ready(function(){
    ...
    interes.on('click',()=>{
      $.ajax({
        url:'http://ec2-54-85-253-12.compute-1.amazonaws.com:3000/aspirantes',
        type:'post',
   ...
   $.post("http://ec2-54-85-253-12.compute-1.amazonaws.com:3000/aspirante", function(data){
    ...
    $.ajax({
      url:'http://ec2-54-85-253-12.compute-1.amazonaws.com:3000/aspirante',
      type:'put',
      dataType:'json',

$(document).ready(()=>{
    ...
    //Petición AJAX 
    $.ajax({
        url:'http://3.93.218.234:80/fotoemp/foto',
        method:'post',
        dataType:'json',
    ...
    $.ajax({
        ...
        url: 'http://3.93.218.234:80/updateE/show',
        method: 'get',
        dataType: 'json',
        success: function (response) {
    ...
    savebtn.click(()=>{
        ...
        $.ajax({
            ...
            url: 'http://3.93.218.234:80/updateE/add',
            method: 'put',
            dataType: 'json',
        ...
        var url = "http://3.93.218.234:80/emp-profile";
...
//Para demás datos
    save.click(()=>{
        ...
        $.ajax({
            ...
            url: 'http://3.93.218.234:80/updateE',
            method: 'put',
            dataType: 'json',
            data: data,
            success: function (response) { console.log(response) }
    ...
    file.on('change', () => {
        ...
        xhr.open('POST', 'http://3.93.218.234:80/fotoemp/', true);
        ...
        var url = "http://3.93.218.234:80/emp-profile";
            ...
            $.ajax({
                url:'http://3.93.218.234:80/fotoemp',
               method:'post',
               data:formdata,
               processData: false,
               contentType: false,

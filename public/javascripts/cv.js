...
$(document).ready(()=>{
    ...
    oidioma.on('click',()=>{
        idiomas=idioma.val(); 
        $.ajax({
            url:'http://54.85.253.12:8080/add-cv',
            method:'post',
            dataType:'json',
            data:{
                idioma:idiomas
    ...
    refBtn.on('click',()=>{
        ...
        $.ajax({
            url:'http://54.85.253.12:8080/add-cv/referencias',
            method:'post',
            dataType:'json',
            data:{
                nomRef:ref,
    ...
    softBtn.on('click',()=>{
        ...
        $.ajax({
            url:'http://54.85.253.12:8080/add-cv/software',
            method:'post',
            dataType:'json',
            data:{
                nomSoft:nameSoft,
    ...
    var du="";
        ...
        (async ()=>{
            async function leng(){
                return $.ajax({
                    url:'http://54.85.253.12:8080/add-cv/showLeng',
                    method:'get',
                    dataType:'json',
                    success:function(response){
                    return response
            ...
            // console.log(l);
             ...
             async function proj(){
                return $.ajax({
                    url:'http://54.85.253.12:8080/add-cv/showProj',
                    method:'get',
                    dataType:'json',
                    success:function(response){
                    return response;
             ...
             async function ref(){
                return $.ajax({
                    url:'http://54.85.253.12:8080/add-cv/showRef',
                    method:'get',
                    dataType:'json',
                    success:function(response){
                    return response;
             ...
             async function DU(){
                return $.ajax({
                    url:'http://54.85.253.12:8080/add-cv/showDU',
                    method:'get',
                    dataType:'json',
                    success:function(response){
                    return response;
            ...
            du=await DU();
             ...
             async function sof(){
                return $.ajax({
                    url:'http://54.85.253.12:8080/add-cv/showSoft',
                    method:'get',
                    dataType:'json',
                    success:function(response){
                    return response;

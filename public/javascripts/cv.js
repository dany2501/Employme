...
var imagen =$("#img");
    ...
    btndesc.on("click",()=>{
        ...
        $.ajax({
            url: 'http://34.227.162.181:8080/add-cv/descripcion',
            method: 'post',
            dataType: 'json',
            data: {
                descripcion: descrip
...
location.reload();
    ...
    oidioma.on('click', () => {
        ...
        idiomas = idioma.val();
        $.ajax({
            url: 'http://34.227.162.181:8080/add-cv',
            method: 'post',
            dataType: 'json',
            data: {
                idioma: idiomas
    ...
    refBtn.on('click', () => {
        ...
        $.ajax({
            url: 'http://34.227.162.181:8080/add-cv/referencias',
            method: 'post',
            dataType: 'json',
            data: {
                nomRef: ref,
    ...
    softBtn.on('click', () => {
        ...
        $.ajax({
            url: 'http://34.227.162.181:8080/add-cv/software',
            method: 'post',
            dataType: 'json',
            data: {
                nomSoft: nameSoft,
    ...
    cvBtn.on('click', () => {
        (async () => {
            async function leng() {
                return $.ajax({
                    url: 'http://34.227.162.181:8080/add-cv/showLeng',
                    method: 'get',
                    dataType: 'json',
                    success: function (response) {
                        return response
            ...
            async function proj() {
                return $.ajax({
                    url: 'http://34.227.162.181:8080/add-cv/showProj',
                    method: 'get',
                    dataType: 'json',
                    success: function (response) {
                        return response;
            ...
            async function ref() {
                return $.ajax({
                    url: 'http://34.227.162.181:8080/add-cv/showRef',
                    method: 'get',
                    dataType: 'json',
                    success: function (response) {
                        return response;
            ...
            async function DU() {
                return $.ajax({
                    url: 'http://34.227.162.181:8080/add-cv/showDU',
                    method: 'get',
                    dataType: 'json',
                    success: function (response) {
                        return response;
            ...
            async function sof() {
                return $.ajax({
                    url: 'http://34.227.162.181:8080/add-cv/showSoft',
                    method: 'get',
                    dataType: 'json',
                    success: function (response) {
                        return response;

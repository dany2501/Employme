$(document).ready(function () {
    ...
    /*foto.on('change', () => {
        ...
        console.log(formdata);
                $.ajax({
                     url:'http://34.227.162.181:8080/fotoasp/',
                    method:'post',
                    data:formdata,
                    processData: false,
                    contentType: false,
...
*/
    ...
    agregar.on('click', () => {
        ...
        var c = correo.val();
            $.ajax({
                url: 'http://34.227.162.181:8080/update',
                method: 'post',
                dataType: 'json',
                data: {
                    numero: n,
            ...
            var url = "http://34.227.162.181:8080/perfilasp";
    ...
    agregar2.on('click', () => {
        ...
        if (usu.length == 0) {
            ...
            $.ajax({
                url: 'http://34.227.162.181:8080/portafolio',
                method: 'post',
                dataType: 'json',
                data: { usuario: usu },
                success: function (response) {
    ...
    agregar3.on('click', () => {
        ...
        if (vid.length == 0) {
            ...
            $.ajax({
                url: 'http://34.227.162.181:8080/video',
                method: 'post',
                dataType: 'json',
                data: { video: vid },
                success: function (response) {
    ...
    $.ajax({
        url:'http://34.227.162.181:8080/perfilasp',
        type:'put',
        dataType:'json',
    ...
    $.get("http://34.227.162.181:8080/perfilasp/user", function(data)
